...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "foocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"foocoin0.foocoin.net", "159.89.139.82"},{"foocoin1.foocoin.net", "104.236.83.53"},{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. foocoin is probably already running."), addrBind.ToString().c_str());
        else
